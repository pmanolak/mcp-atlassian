...
def test_jira_mcp(mock_jira_fetcher, mock_base_jira_config):
    ...
    jira_sub_mcp.tool()(get_issue.fn)
    jira_sub_mcp.tool()(search.fn)
    jira_sub_mcp.tool()(search_fields.fn)
    jira_sub_mcp.tool()(get_project_issues.fn)
    jira_sub_mcp.tool()(get_project_versions.fn)
    jira_sub_mcp.tool()(get_all_projects.fn)
    jira_sub_mcp.tool()(get_transitions.fn)
    jira_sub_mcp.tool()(get_worklog.fn)
    jira_sub_mcp.tool()(download_attachments.fn)
    jira_sub_mcp.tool()(get_agile_boards.fn)
    jira_sub_mcp.tool()(get_board_issues.fn)
    jira_sub_mcp.tool()(get_sprints_from_board.fn)
    jira_sub_mcp.tool()(get_sprint_issues.fn)
    jira_sub_mcp.tool()(get_link_types.fn)
    jira_sub_mcp.tool()(get_user_profile.fn)
    jira_sub_mcp.tool()(create_issue.fn)
    jira_sub_mcp.tool()(batch_create_issues.fn)
    jira_sub_mcp.tool()(batch_get_changelogs.fn)
    jira_sub_mcp.tool()(update_issue.fn)
    jira_sub_mcp.tool()(delete_issue.fn)
    jira_sub_mcp.tool()(add_comment.fn)
    jira_sub_mcp.tool()(add_worklog.fn)
    jira_sub_mcp.tool()(link_to_epic.fn)
    jira_sub_mcp.tool()(create_issue_link.fn)
    jira_sub_mcp.tool()(remove_issue_link.fn)
    jira_sub_mcp.tool()(transition_issue.fn)
    jira_sub_mcp.tool()(update_sprint.fn)
    jira_sub_mcp.tool()(batch_create_versions.fn)
